...
{
#if UNITY_EDITOR
internal class StandardCausticsShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
        ...
        public static string causticsStartlevelText = "Start Level";
        public static string causticsShallowFadeDistanceText = "Shallow Distance";
        public static string causticsScaleText = "Scale";
        public static string causticsDriftText = "Drift";
    ...
    MaterialProperty causticsStartLevel = null;
    MaterialProperty causticsShallowFadeDistance = null;
    MaterialProperty causticsScale = null;
    MaterialProperty causticsDrift = null;
